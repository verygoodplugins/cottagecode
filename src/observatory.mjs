...
export function createObservatory(api){
  ...
  function renderPanel(id){
    ...
    const actions='<div class="cottage-actions">'+button(mode==='room'?'leave':'enter',mode==='room'?'Leave cottage ↗':'Enter cottage ↗')+button('follow',followId===a.id?'Leave bench':'Follow from bench')+'</div>';
